...
// string func20 (int quarter)
// {
//        if (quarter == 1) return "Диапазон X от 0 до бесконечности, y от 0 до бесконечности, y"; 
//        if (quarter == 2) Console.WriteLine ("Диапазон X от 0 до бесконечности, y от 0 до бесконечности, y"); 
